...
public class FiguraView extends JFrame {
	...
	private void escolherFigura(ActionEvent e) {
		...
		alturaSpinner.setValue(f.getLargura());
		...
		/*
		 * IF (F INSTANCEOF UNIDIMENSIONAL) { LARGURALABEL.SETVISIBLE(FALSE);
		 * LARGURASPINNER.SETVISIBLE(FALSE); ALTURALABEL.SETTEXT("LADO: "); } ELSE {
		 * LARGURALABEL.SETVISIBLE(TRUE); LARGURASPINNER.SETVISIBLE(TRUE);
